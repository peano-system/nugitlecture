...
%%%%%%%%%%%
\begin{document}
正の整数$n$の正の平方根$\sqrt{n}$が整数でなく, 十進数における小数点第1位が0となり, かつ第2位が0でないとき, $\sqrt{n}$の整数部分を$a$とおくと$a \ge 1$であり, $n$と$a$の関係は
\begin{equation*}
 a+0.01 \le \sqrt{n} < a+0.1
\end{equation*}
で表される. 各辺を2乗して$a^2$を引くと, $a \ge 1$から$0.02a+0.0001>0$となるため, 
\begin{equation}
